...
This document describes interfaces of RSS3 files.
...
[GitHub Discussions](https://github.com/NaturalSelectionLabs/RSS3/discussions) are preferred for discussion of this specification.
...
- RSS3Item - A original item published by current persona (root item) or a interactive item from other persona (context item)
...
- `items`: A list. Its type and meaning depends on the type of current file. It is explained separately below.
...
- `profile`: Profile of current persona
    ...
    - `avatar`: Avatar of current persona. It is a address that links to a third party file
...
- `links`: Relationships for this persona, for example: followings followers blocklist
    - `id`: It is a ID that links to a RSS3Link file
...
**RSS3OtherPersona:** indicating other persona, used in RSS3Link and RSS3Item

- `id`: It is a ID that links to a RSS3Persona file
...
- `avatar`: Avatar of this persona. It is a address that links to a third party file
- `bio`: Bio of this persona

**RSS3Item:** indicating a content posted by a persona or a context

- `id`: Unique ID of current item
...
- `contents`: Contents of current item, possibly multiple different types of content
    - `id`: Actual content. It is a address that links to a third party file
...
- `contexts`: Interactive items from other persona
    - `id`: It is a ID that links to a RSS3Items file
    - `name`: Name of current context
    - `tags`: Tags of current context
