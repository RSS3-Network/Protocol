...
. BruceXC (https://github.com/brucexc[*@brucexc*])
. Henry (https://github.com/HenryQW[*@HenryQW*])
. KallyDev https://github.com/kallydev[*@kallydev*]
. Nya Candy (https://github.com/Candinya[*@Candinya*])
. Polebug (https://github.com/Polebug[*@Polebug*])
. pseudoyu (https://github.com/pseudoyu[*@pseudoyu*])
. Thomas (https://github.com/naaive[*@naaive*])
...
The Protocol improves scalability, interoperability, and performance while reducing the stroage cost for the RSS3 DSL.
